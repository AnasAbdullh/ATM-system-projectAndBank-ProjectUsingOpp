...
private:
    ...
    static  vector <clsCurrency> _LoadCurrencysDataFromFile()
    {
        ...
        fstream MyFile;
        MyFile.open("/data/data/com.ikou.cppcoding/files/code_project/Hello_World/src/Currencies.txt", ios::in);//read Mode
    ...
    static void _SaveCurrencyDataToFile(vector <clsCurrency> vCurrencys)
    {
        ...
        fstream MyFile;
        MyFile.open("/data/data/com.ikou.cppcoding/files/code_project/Hello_World/src/Currencies.txt", ios::out);//overwrite
...
public:
    ...
    double ConvertCurrencyToUS(double Amount)
    {
      return Amount / _Rate ;
      
    }
    
    double ConvertFromOneCurrencyToAnother(double Amount)
    {
    ...
    static bool CurrencyCalculator(clsCurrency Currency)
    {
